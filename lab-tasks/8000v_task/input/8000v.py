...
output = net_connect.send_config_set("host 8000v-1")
print(output)
...
print(net_connect.send_command("guestshell enable"))

output = net_connect.send_command("end")
print(output)

print(net_connect.send_command("guestshell"))

output = net_connect.send_command("end")
print(output)

print(net_connect.send_command("sudo pip3 install awscli"))

output = net_connect.send_command("end")
print(output)

print(net_connect.send_command("sudo pip3 install csr_aws_guestshell"))
