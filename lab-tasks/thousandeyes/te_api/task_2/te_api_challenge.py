...
found_values = []
for dictionary in list_of_dictionaries:
    if (dictionary["testName"] == "test-100"):
        found_values.append(dictionary)
print(found_values)
empty_list=[]
...
#Change a metadata value - look in the gui, notice the names in the gui do not match exactly the metadata
#names in the API..
#https://developer.thousandeyes.com/v6/tests/#/test_update
