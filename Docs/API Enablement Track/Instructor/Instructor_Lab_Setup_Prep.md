...
#fly -t cisco-fso-labs set-pipeline -c pipeline-v4.yml -p cisco-fso-labs -l [full path to the params file] -v aws.region=us-east-2 -v az.name=us-east-2c -v vault.addr=http://dev-vault.ciscolivedemo2022.com:8200
