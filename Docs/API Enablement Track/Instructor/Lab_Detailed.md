...
7. Update the params file with your branch name and your SSH private key. You can name the params file by your branch example: us-west-2a.yml
...
example:
Login to a Team
fly -t ci login --concourse-url=http://dev-ci.devops-ontap.com:8080 -n cisco-fso-labs --username=
