...
curl -L -O -H "Authorization: Bearer x..30MgVuNZFdethGyr-znd3npIvuohv3QQC31Uy8jFlys;" "https://download.appdynamics.com/download/prox/download-file/sun-jvm/22.4.0.33722/AppServerAgent-22.4.0.33722"

https://download.appdynamics.com/download/prox/download-file/java-jdk8/23.4.0.34758/AppServerAgent-1.8-23.4.0.34758.zip
Click

curl -L -O -H "Authorization: Bearer x.x.30MgVuNZFxxdethGyr-znd3npIvuohv3QQC31Uy8jFlys;" "https://download.appdynamics.com/download/prox/download-file/sun-jvm/java-jdk8/22.4.0.33722/AppServerAgent-1.8-22.4.0.33722.zip"
